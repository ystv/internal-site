...
export interface Completeposition_groups
  extends z.infer<typeof _position_groupsModel> {
 ...
 */
export const position_groupsModel: z.ZodSchema<Completeposition_groups> =
  z.lazy(() =>
    _position_groupsModel.extend({
