...
import { Completeattendees, attendeesModel, CompleteUser, UserModel, Completesignup_sheets, signup_sheetsModel } from "./index"
 ...
 */
export const eventsModel: z.ZodSchema<Completeevents> = z.lazy(() => _eventsModel.extend({
